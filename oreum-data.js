...
window.OREUM = {
  ...
  regPopup: function(){
    ...
    ov.innerHTML='<div class="rp-card rp-wide">'
      ...
      +'<div class="rp-h">추석 연휴 기간<br><b>수업 시간</b>에 대해 안내합니다</div>'
      +'<div class="rp-sub">가족과 함께 따뜻하고 풍성한 한가위 보내시길 바랍니다.</div>'
      +'<div class="hp-sec chg">수업 변경반<span class="ln"></span></div>'
      +'<div class="hp-table chg">'
      +'<div class="hp-row h"><span class="cls">중2</span><span class="tm"><em>9/24(목)</em> 14:00–17:00</span></div>'
      +'<div class="hp-row h"><span class="cls">중3</span><span class="tm"><em>9/24(목)</em> 10:30–13:30</span></div>'
      +'<div class="hp-row h"><span class="cls">산본고1 <small>은규T</small></span><span class="tm"><em>9/24(목)·25(금)</em> 10:00–13:00</span></div>'
      +'<div class="hp-row h"><span class="cls">흥진고1 · 군포고1 · 군포고2</span><span class="tm"><em>9/26(토)</em> 10:00–19:00 클리닉형</span></div>'
      +'<div class="hp-row h"><span class="cls">용호고2</span><span class="tm"><em>9/29(화)</em> 14:00~ 직전 보강 대체</span></div>'
      +'</div>'
      +'<button class="hp-fold" onclick="this.classList.toggle(\'open\');document.getElementById(\'hpNormal\').classList.toggle(\'open\')"><span>정상 수업반 · 기존 시간 그대로 — 11개 반 펼쳐보기</span><span class="material-symbols-outlined">expand_more</span></button>'
      ...
      +'</div>'
      +'</div>'
      +'<div class="hp-note">클리닉형·등원 세부 안내는 반별 공지로 전달됩니다.</div>'
      +'<a class="rp-cta" href="#" onclick="OREUM.closePop();return false;" style="margin-top:20px">확인했어요</a>'
